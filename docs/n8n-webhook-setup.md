...
- **حساب مربوط ومعتمد من برق**: المحادثة لتاجر الحساب.
- **حساب غير مربوط أو غير معتمد بعد**: محادثة بلا تاجر يراها فريق برق وحده،
  ...
  بالتاجر تلقائياً حين يعتمد مالك المنصة حسابه من `/admin`.
- **بلا معرّف**: القاعدة القديمة مؤقتاً، أي المتجر الأول. يُلغى هذا الاستثناء
  في الترحيل ٠٢٠ بعد تحديث المسار.
